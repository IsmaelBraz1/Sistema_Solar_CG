...
- **[Three.js](https://threejs.org/):** Biblioteca JavaScript para criação e manipulação de gráficos 3D.
- **[Vite](https://vitejs.dev/):** Ferramenta de build rápida que melhora o desempenho durante o desenvolvimento.
